                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                <li><a href="#" onclick="return status_change('lost_posts','id',<?=$list->lost_id?>,0,'lost_status');" title="Click to Inactive">Inctive</a></li>
                                                <li><a href="#" onclick="return status_change('lost_posts','id',<?=$list->lost_id?>,2,'lost_status');" title="Click to Pending">Pending</a></li>
                                            </ul>
                                        </div>
                                    </td>
                                    <td>
