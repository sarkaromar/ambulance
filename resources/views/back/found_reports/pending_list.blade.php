                        ...
                        <table id="data_table" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr id="row_<?=$list->found_id?>">
                                    <td><input class="checkbox1" type="checkbox" name="selected[]" id="del_<?=$list->found_id?>" value="<?=$list->found_id?>-img/category/<?php //echo $category->image;  ?>" /></td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                <li><a href="#" onclick="return status_change('found_posts','id',<?=$list->found_id?>,1,'found_status');" title="Click to Active">Active</a></li>
