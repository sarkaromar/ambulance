...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-12">
                <a href="{{ url('/admin/active-found-lists') }}" class="btn btn-app">
                    <span class="badge bg-green">{{ $active }}</span>
                    <i class="fa fa-bullhorn"></i> Active List
                </a>
                <a href="{{ url('/admin/pending-found-lists') }}" class="btn btn-app">
                    <span class="badge bg-yellow">{{ $pending }}</span>
                    <i class="fa fa-barcode"></i> Pending List
                </a>
                <a href="{{ url('/admin/inactive-found-lists') }}" class="btn btn-app">
                        ...
                        <table id="data_table" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr id="row_<?=$list->found_id?>">
                                    ...
                                    <td>{{ $list->found_item_name }}</td>
                                    <td>{{ $list->post_category_name }}</td>
                                    <td>{{ $list->divi_name }}</td>
                                    <td>{{ $list->area_name }}</td>
                                    <td>{{ $list->created_at }}</td>
                                    <td><img src="{{ URL::to('assets/images/found_report/' . $list->found_item_image) }}" alt="{{ $list->found_item_name }}" width="100px"></td>
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                <li><a href="#" onclick="return status_change('found_posts','id',<?=$list->found_id?>,2,'found_status');" title="Click to Pending">Pending</a></li>
                                                <li><a href="#" onclick="return status_change('found_posts','id',<?=$list->found_id?>,0,'found_status');" title="Click to Inactive">Inactive</a></li>
                                            </ul>
                                        </div>
                                    </td>
                                    <td>
                                        <a class="btn btn-info" data-toggle="modal" href="#edit_<?=$list->found_id?>" title="View"><i class='fa fa-search'></i></a>
                                        <a class="btn btn-primary" data-toggle="modal" href="#edit_<?=$list->found_id?>" title="Edit"><i class='fa fa-pencil-square-o'></i></a>
                                        <script>
                                            var table = ["found_posts"];
                                            var field = "id";
                                            var image = [];
                                        </script>
                                        <a class="btn btn-danger" href="#" onclick="return dodelete(table,field,<?=$list->found_id?>, image);" title="Delete"><i class='fa fa-trash-o'></i></a>
                                    </td>
                                </tr>
                                <!-- view modal -->
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            {{ csrf_field() }}
                                                ...
                                                @php
                                                echo "<pre>";
                                                echo "Item Name:" . $list->found_item_name;
                                                echo "<br>";
                                ...
                                <div class="modal fade" id="edit_<?=$list->lost_id?>" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form method="POST" action="{{ url('/admin/update-area/' . $list->found_id)  }}" method="POST">
                                            {{ csrf_field() }}
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-md-12">
