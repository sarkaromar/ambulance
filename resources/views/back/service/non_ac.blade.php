        ...
        <div class="row">
            <div class="col-md-12">
                                        ...
                                        <div id="edit_{{$list->service_slider_id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <form method="POST" action="{{ url('admin/update-non-ac-slider', $list->service_slider_id) }}" enctype="multipart/form-data">
                                                        {{ csrf_field() }}
                ...
                <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="{{ url('/admin/add-non-ac-slider') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-md-12">
                ...
                <div class="box">
                    ...
                    <form method="POST" action="{{ url('/admin/update-non-ac-short-desc/')  }}">
                    {{ csrf_field() }}
                        <div class="box-body">
                            <div class="form-group">
                                <div class="col-md-12">
                ...
                <div class="box">
                    ...
                    <form method="POST" action="{{ url('/admin/update-non-ac-service-info/')  }}">
                    {{ csrf_field() }}
                        <div class="box-body">
                            <div class="form-group">
                                <div class="col-md-12">
