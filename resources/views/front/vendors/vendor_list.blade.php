                ...
                <div class="filters">
                    ...
                    <form class="form" action="{{ url('vendors-search-list') }}" method="GET">
                        ...
                        <select class="form-control" name="type" id="type" required>
                            ...
                            <option value="{{ $vendors_type->vendor_types_slug }}" <?php if(!empty($type)){ if($vendors_type->vendor_types_id == $type){echo 'selected';}}?> >{{ $vendors_type->vendor_types_name }}</option>
                            @endforeach
                            @endif
                        </select>
                        ...
                        <select class="form-control" name="area" id="area_slug_venue" required>
                            ...
                            <option value="{{ $area_info->ar_slug }}" <?php if(!empty($area)){ if($area_info->id == $area){echo 'selected';}} ?> >{{ $area_info->ar_name }}</option>
                            @endforeach
                            @endif
                        </select>
                        <br>
            ...
            <div class="col-lg-8">
                ...
                @if(!empty($vendors[0]))
                    ...
                    <div class="venues">
                        <div class="row">
                            <div class="col-lg-3">
                                <img src="{{ asset($vendor->vendor_banner_image != '' ? 'img/vendor_photo/'.$vendor->vendor_banner_image : 'img/empty_img.png') }}" alt="{{ $vendor->cre_full_name }}">
                            </div>
                            <div class="col-lg-6">
