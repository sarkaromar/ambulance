        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6">
                    <h2 class="title"><span>Lost :</span> {{ $list->lost_item_name }}</h2>
                    <h4 class="title cate"><span>Category :</span> {{ $list->post_category_name }}</h4>
                    <dl class="details">
                        <dt>Where</dt>
                        <dd>{{ $list->lost_address }}, {{ $list->area_name }}, {{ $list->divi_name }}</dd>
                    </dl>
                    <dl class="details">
                        <dt>When</dt>
                        <dd>{{ $list->lost_date }}</dd>
                    </dl>
                    <div class="desc">
                ...
                <div class="col-md-6">
                    <div class="details-img">
                       <img class="img img-responsive" src="{{ URL::to('assets/images/lost_report' , $list->lost_item_image) }}" alt="{{ $list->lost_item_name }}">
                    </div>
                </div>
                @else
                <div class="col-lg-12">
