                ...
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        <div class="form-group">
                            ...
                            <input type="text" id="datepicker" class="form-control" name="LostDate" placeholder="lost date here" readonly>
                        </div>
                    </div>
                    <div class="col-lg-2">
                    ...
                    <div class="i-card">
                        ...
                        <div class="i-card-body lost-bg">
                            <a href="{{ url('/lost-item-details/'. $list->lost_id) }}" class="i-text">
                              ...
                              <div class="hh">@php if($list->lost_reword == 0){echo 'No Reward'; }else{ echo $list->lost_reword; } @endphp</div>
                            </a>
                        </div>
                    </div>
                </div>
