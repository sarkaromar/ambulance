  ...
  <section class="main-body">
    ...
    <div class="report">
        <div class="container">
            ...
            @endif
            <form action="{{ url('send-lost-report') }}" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
                <div class="form-group row">
                    <label for="inputItemName" class="col-sm-3 col-form-label">What have you lost? <sup style="color:red">*</sup></label>
                    <div class="col-sm-4">
                ...
                <div class="form-group row">
                    <label for="division" class="col-sm-3 col-form-label">Where did you lose it? <sup style="color:red">*</sup></label>
                    <div class="col-sm-4">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" name="LostAddress" placeholder="street address" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="inputPassword" class="col-sm-3 col-form-label">When did you lose it? <sup style="color:red">*</sup></label>
                    <div class="col-sm-4">
                        <input type="text" id="datepicker" class="form-control" name="LostDate" placeholder="lost date here" readonly required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="inputPassword" class="col-sm-3 col-form-label">Do you want to offer a reward?</label>
                    <div class="col-sm-4">
                        <label><input type="checkbox" name="Reward"> Yes</label>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md-3"></div>
                    <div class="col-md-6">
                        <textarea class="form-control" rows="2" name="RewardNote" placeholder="Any note for reward (optional field)"></textarea>
                    </div>
                </div>
                <div class="form-group row">
