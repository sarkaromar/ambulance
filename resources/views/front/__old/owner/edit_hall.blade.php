                            ...
                            <div class="card" id="highlight-">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('update_hall') }}" method="POST"  enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <img src="{{ URL::to('images/hall/', $info[0]->ha_m_image ) }}" alt="{{ $info[0]->ha_name }}" width="80px">
                                        ...
                                        <div class="form-group">
                                            @foreach($images as $image)
                                                <img src="{{ URL::to('images/hall/', $image->ha_image ) }}" alt="{{ $info[0]->ha_name }}" width="80px" style="margin-right: 5px">
