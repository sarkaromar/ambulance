                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-10">
                                    <div class="venue-list">
                                        @if(isset($hall_vanue[0]))                  
                                        @foreach($hall_vanue as $val)
                                        <div class="venues">
                                            <div class="row">
                                                <div class="col-lg-2">
                                                    <img src="{{ URL::to('img/hall_photo/', $val->ha_m_image) }}" alt="{{ $val->ha_name }}">
                                                </div>
                                                <div class="col-lg-8">
                                                ...
                                                <div class="col-lg-2">
                                                    <a href="{{ URL::to('user-hall-details', $val->ha_slug) }}" class="btn btn-info btn-block">Details</a>
                                                </div>
                                            </div>
                                        </div>
                                        @endforeach
